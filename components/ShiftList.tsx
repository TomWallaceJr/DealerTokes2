...
export default function ShiftList() {
  ...
  async function removeShift(id: string) {
    ...
    try {
      ...
      // Optional: backfill one more item to keep page filled
        ...
        {shifts.map((s) => {
          ...
          return (
            ...
            >
              ...
              <button
                className="absolute right-2 top-2 rounded p-1 text-zinc-400 hover:text-red-400 hover:bg-red-900/20 focus:outline-none focus:ring-2 focus:ring-red-500"
                title="Delete shift"
